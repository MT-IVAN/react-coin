...
class Detail extends React.Component {
    ...
    componentDidMount(){
        ...
        const currencyId = this.props.match.params.id; // Esto se puede ver en la consola, todos los props que tiene detail
        ...
        return (
            <div className="Detail">
                ...
                <div className="Detail-container">    
                    ...
                    <div className="Detail-item">
                        24H Change <span className="Detail-value">{mostrarCambioDePorcentaje(currency.percentChange24h)}</span>
                    </div>
                    <div className="Detail-item">
